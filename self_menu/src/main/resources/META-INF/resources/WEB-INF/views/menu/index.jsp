...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/hongzw/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/hongzw/menu/js/jquery.js"></script>
<script type="text/javascript" src="/hongzw/menu/js/vue.js"></script>
<script type="text/javascript" src="/hongzw/menu/js/menu.js"></script>
