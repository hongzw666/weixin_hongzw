...
import com.hong.commons.domain.text.TextOutMessage;
import com.hong.commons.service.TokenManager;
...
public class WeixinProxy {
	...
	public void sendText(String account, String openId, String content) {
		...
		try {
			...
			LOG.error("通过客服接口发送出现问题: " + e.getLocalizedMessage(), e);
		}
	}
